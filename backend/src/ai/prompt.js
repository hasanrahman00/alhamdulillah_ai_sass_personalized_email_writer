...
const COLD_EMAIL_PROMPT_WITH_FOLLOW_UP_TEMPLATE = [
	...
	'• IMPORTANT: Because AI inbox filters now categorize messages, make your opening feel like a referral or warm introduction. Briefly reference a mutual contact, community or event (without inventing specific names) to explain how you obtained the recipient’s contact. Example: “I got your contact through a mutual connection in our [industry] group who said you’d be interested in [value proposition].” Avoid generic, scraped-sounding phrases like “saw you’re a [role]” or “noticed the [feature] you launched.”',
	'• Emphasize that you’re sharing a relevant insight or solution recommended by this mutual connection, not pitching at random. Connect one clear benefit of your offer to the pain point implied by the context.',
...
function buildDeepSeekPrompt({
	...
	return [
		...
		'1d) AI inbox filtering: To avoid being categorized as marketing, frame the opening_line as a warm introduction or referral. Reference a mutual connection or shared community (do not invent specific names) and tie it to the value proposition. Do NOT use scraping-sounding phrases like “saw you’re a [role]”; instead, say you were directed by someone who thought the prospect would appreciate your solution.',

...
const COLD_EMAIL_BULK_PROMPT_WITH_FOLLOW_UP_TEMPLATE = [
	...
	'• IMPORTANT: New AI inbox filters classify emails by intent. To avoid being labeled “Marketing,” your opening line MUST feel like a warm introduction or referral. Mention a plausible mutual connection or shared community (without inventing specific names) that justifies the outreach. Example: “I got your contact through a mutual connection in the [industry] network who thought you’d be interested in [value proposition].” Avoid scraping-like phrases such as “saw you’re a [role]” or “noticed the [feature] you launched.”',
	'• Frame the purpose of your email as sharing a valuable insight or responding to a recommendation rather than pitching a product. Do not list multiple services; instead, connect one clear benefit to the pain point surfaced by the mutual connection or context.',
